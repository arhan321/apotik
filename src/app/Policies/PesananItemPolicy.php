...
class PesananItemPolicy
{
    ...
    {
        return $user->can('view_any_pesanan::item');
    }
    ...
    {
        return $user->can('view_pesanan::item');
    }
    ...
    {
        return $user->can('create_pesanan::item');
    }
    ...
    {
        return $user->can('update_pesanan::item');
    }
    ...
    {
        return $user->can('delete_pesanan::item');
    }
    ...
    {
        return $user->can('delete_any_pesanan::item');
    }
     ...
     */
    public function replicate(User $user, PesananItem $pesananItem): bool
    {
