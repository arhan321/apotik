    ...
    <div class="card shadow rounded-4 p-3 p-md-4">
      <div class="row justify-content-center">
        <div class="col-12">
          ...
          <!-- Form Start -->
          <form action="<?php echo e(route('pesananresep.submit')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/frontend/pesananresep.blade.php ENDPATH**/ ?>